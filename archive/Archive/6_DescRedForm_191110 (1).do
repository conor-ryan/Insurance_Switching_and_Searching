...
/// TABLE: ENROLLMENT, PLAN OFFERINGS, PREMIUMS, AND MARKET SHARES ///
...
/// TABLE: CHARS OF PLAN SELECTIONS ACROSS ENROLLMENT COHORTS ///
...
g switch = (netname!=autonet | metal6!=lagmetal6) & planchoice!=autoplanid
...
egen mtlfe = group(lagmetal6)

* Regression

global dem i.age3 fam s_hassub

eststo s1: qui areg switch auto_p_post undp $dem i.mtlfe i.year, a(gra) cluster(idhh)
eststo s2: qui areg switch autodp      undp $dem i.mtlfe i.year, a(gra) cluster(idhh)

eststo a1: qui areg active auto_p_post undp $dem i.mtlfe i.year, a(gra) cluster(idhh)
eststo a2: qui areg active autodp      undp $dem i.mtlfe i.year, a(gra) cluster(idhh)
