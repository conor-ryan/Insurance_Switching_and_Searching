...
g auto_p_pre = fageadj[_n+1] * autoprem if idhh==idhh[_n+1]
...
foreach y of varlist autoprem autoplanchange-autodp base_dprem mean_dprem_all mean_dprem_mtl auto_mean_prem_all auto_mean_prem_mtl{ 
	replace `y' = `y'[_n-1] if idhh==idhh[_n-1] & year==2018 & year[_n-1]==2017
	replace `y' = `y'[_n-1] if idhh==idhh[_n-1] & year==2017 & year[_n-1]==2016
	replace `y' = `y'[_n-1] if idhh==idhh[_n-1] & year==2016 & year[_n-1]==2015
	replace `y' = `y'[_n-1] if idhh==idhh[_n-1] & year==2015 & year[_n-1]==2014
