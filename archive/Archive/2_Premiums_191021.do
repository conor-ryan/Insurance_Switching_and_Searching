...
* Lagged Networks for Inertia Matching

use proc/planchars, clear
duplicates drop year gra issuername plantype, force
drop metal planid prem pmtlord bp
sort issuername gra year

replace plantype="HSP" if issuername=="HealthNet" & plantype=="EPO" & year==2015 
replace plantype="HMO" if issuername=="Kaiser" // Captures HSAs
