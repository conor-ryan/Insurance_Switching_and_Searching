...
g autodp = auto_p_post - p_post // Missing vals are contra costa, united, and 2018
lab var autodp "Change in Post-Subsidy Premium: Auto Assigned Plan re Last Year's Plan"

count if autodp==. & idhh==idhh[_n+1] // 1,086
...
foreach y of varlist autoplanid autonet autoiss {
	replace `y' = `y'[_n-1] if idhh==idhh[_n-1] & year==2018 & year[_n-1]==2017
