...
_pctile base_dprem, p(95 98)

gen thresh_premchg_95 = r(r1)
gen thresh_premchg_98 = r(r2)

egen choiceset_exceed_thresh_95 = max(base_dprem>thresh_premchg_95), by(gra)
egen choiceset_exceed_thresh_98 = max(base_dprem>thresh_premchg_98), by(gra)
drop thresh_premchg_95 thresh_premchg_98
